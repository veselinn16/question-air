...
class Arrange extends Component {
    ...
    componentDidMount() {
        if (this.dom.listQuestions.length > 0) {
            ...
            TweenLite.to(this.dom.container, 0.5, { autoAlpha: 1 })
        }
    }
    ...
    //     const sortables = this.dom.listQuestions.map(Sortable); // array of questions
    //     let total = sortables.length; // length of questions array
    //     const container = this.dom.container; // container ref
