...
export default function initBt2(button) {
  let bt = button;
  let filter = document.querySelectorAll('#filter-goo feGaussianBlur')[0];
  let particleCount = 12;
  let colors = ['#DE8AA0', '#8AAEDE', '#FFB300', '#60C7DA']
  ...
  bt.addEventListener('click', function() {
    ...
    tl.to(bt.querySelectorAll('.btn-bg'), 0.6, { scaleX: 1.05 });
    tl.to(bt.querySelectorAll('.btn-bg'), 0.9, { scale: 1, ease: Elastic.easeOut.config(1.2, 0.4) }, 0.6);
